...
> Design notes for **watermarked-creator-fulfillment** — a runnable typescript example that A typed checkout workflow that watermarks creator images before fulfillment and receipt creation.
...
- **Feature code** — the actual task: creator image fulfillment.
